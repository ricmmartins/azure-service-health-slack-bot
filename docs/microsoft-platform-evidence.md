...
|---|---|---|
| Common Alert Schema places common fields in `data.essentials` and alert-specific fields in `data.alertContext`. | [Common Alert Schema](https://learn.microsoft.com/azure/azure-monitor/alerts/alerts-common-schema) | Official. The application additionally validates required Service Health fields. |
